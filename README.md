...
版本：v0.4 UI、NPC 与商店 headless 闭环完成，待 GUI 验收
...
- v0.4 UI、NPC 与商店已完成 headless 闭环：HUD 更新接口、背包/装备/对话/商店面板、UI Root、NPC/商店演示数据、UI 风格规范和青木村村长/商人/铁匠交互入口已接入。
- 当前下一步是手动验收 v0.4 UI 布局和交互观感。
